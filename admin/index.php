...
<!-- Todo js -->
<script src="/like-girl5.0.0-master/admin/assets/js/ui/component.todo.js"></script>

<!-- demo app -->
<script src="/like-girl5.0.0-master/admin/assets/js/pages/demo.dashboard-crm.js"></script>
<?php
