...
<head>
    ...
    <!-- App css -->
    <link href="/like-girl5.0.0-master/admin/assets/css/icons.min.css" rel="stylesheet" type="text/css"/>
    <link href="/like-girl5.0.0-master/admin/assets/css/app.min.css" rel="stylesheet" type="text/css"/>
    <link href="/like-girl5.0.0-master/Style/css/loading.css" rel="stylesheet">
</head>
            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="/like-girl5.0.0-master/admin/loginPost.php" method="post" onsubmit="return check()">
...
<!-- App js -->
<script src="/like-girl5.0.0-master/admin/assets/js/app.min.js"></script>
</body>
</html>